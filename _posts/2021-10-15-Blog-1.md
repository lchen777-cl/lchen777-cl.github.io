...
Sadly we cannot put the original interactive graph to the post.

## §4. Create Two More Interesting Figures

Let's create at two more complex and interesting interactive data visualizations using the same data set. 
...
As shown in the graph, we can see there are some years with annormally many anomalies. We can further research on what had happened in those years to better understand anomalies.
...
The function is built as followed:
...
We can see there are some stations that don't follow the geograpgical pattern. We can further look at these stations' geographical environments to see what's going on.
